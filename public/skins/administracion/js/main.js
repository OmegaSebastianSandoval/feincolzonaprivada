$(document).ready(function () {
  ...
  //funcion para cambiar la fecha deel estado de cuenta deel mes actual
  mesEstado = document.getElementById("info_pagina_mes");
  // Agregar un comentario explicativo sobre el propósito de este evento
  mesEstado
    ? mesEstado.addEventListener("change", async function () {
        console.log(mesEstado.value);

        fetch(
          "/administracion/archivoestadocuenta/updatemes/?mes=" +
            mesEstado.value,
          {
            method: "post",
            headers: {
