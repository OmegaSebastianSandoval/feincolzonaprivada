<div class="container d-grid justify-content-center pb-5 mt-5">
  <section class="shadow p-5 ">
        ...
        <h3 class="login-title" style="font-size: 2.4rem;">Cambia tu contraseña</h3>
        ...
        <?php } else { ?>
            <form class="form" action="/page/login/recuperarclave" id="form-recuperar" method="post">
                ...
                <input type="password" class="input mb-3" name="password2" id="client-password2" placeholder="Repite tu contraseña" required>
