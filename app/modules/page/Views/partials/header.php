<nav class="navbar navbar-expand-lg p-0">
    <div class="container d-flex">
        <a class="navbar-brand" href="/"><img src="/corte/Logo-Footer.png" class="img-fluid rounded-top" alt="Logo Feincol"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if ($_SESSION["user"]) { ?>
                    <li class="nav-item links-redes border-0 content-cerrar">
                        <a href="/page/index/logout" class="Btn">
